...
taskset -c 0,2 ./zenoh-c/build/zenoh_pong -c ./config/peer-listen.json5
sleep 1 && taskset -c 1,3 ./zenoh-c/build/zenoh_ping -c ./config/peer-connect.json5 -s 64 -i 0 > $LOG_FILE
